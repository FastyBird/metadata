...
final class ConnectorControlEntityFactory extends Entities\EntityFactory
{
	 ...
	 *
	 * @return IConnectorControlEntity
	 *
	 * @throws Exceptions\FileNotFoundException
	 */
	public function create(string $data, Types\RoutingKeyType $routingKey): IConnectorControlEntity
	{
		if (
		...
		$entity = $this->build(ConnectorControlEntity::class, $validated);

		if ($entity instanceof ConnectorControlEntity) {
			return $entity;
		}
