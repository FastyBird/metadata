...
final class Constants
{
	...
	public const JSON_SCHEMAS_MAPPING = [
		...
		self::MODULE_DEVICES_ORIGIN  => [
			...
			self::MESSAGE_BUS_DEVICES_HARDWARE_CREATED_ENTITY_ROUTING_KEY => self::RESOURCES_FOLDER . DIRECTORY_SEPARATOR . 'schemas' . DIRECTORY_SEPARATOR . 'devices-module' . DIRECTORY_SEPARATOR . 'entity.device.hardware.json',
			self::MESSAGE_BUS_DEVICES_HARDWARE_UPDATED_ENTITY_ROUTING_KEY => self::RESOURCES_FOLDER . DIRECTORY_SEPARATOR . 'schemas' . DIRECTORY_SEPARATOR . 'devices-module' . DIRECTORY_SEPARATOR . 'entity.device.hardware.json',

			self::MESSAGE_BUS_DEVICES_FIRMWARE_CREATED_ENTITY_ROUTING_KEY => self::RESOURCES_FOLDER . DIRECTORY_SEPARATOR . 'schemas' . DIRECTORY_SEPARATOR . 'devices-module' . DIRECTORY_SEPARATOR . 'entity.device.firmware.json',
			self::MESSAGE_BUS_DEVICES_FIRMWARE_UPDATED_ENTITY_ROUTING_KEY => self::RESOURCES_FOLDER . DIRECTORY_SEPARATOR . 'schemas' . DIRECTORY_SEPARATOR . 'devices-module' . DIRECTORY_SEPARATOR . 'entity.device.firmware.json',
		],
