...
final class ActionChannelControlEntityFactory extends Entities\EntityFactory
{
	 ...
	 */
	public function create(string|array|Utils\ArrayHash $data): ActionChannelControl
	{
		if (is_string($data)) {
		...
		$entity = $this->build(ActionChannelControl::class, $data);

		if ($entity instanceof ActionChannelControl) {
			return $entity;
		}
